...
- 项目：11DingKing/goeb409f-t008-02
...
1. 预期退出码 1：`go test ./internal/domain/ -run "^TestProcess_CommandWindowWhenGridLossTimeUnknown$|^TestProcess_CommandOverdue$" -count=1 -v`
